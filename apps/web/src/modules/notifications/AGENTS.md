...
- Inbox 是本 module 的 recipient-facing presentation projection；Notification truth、read-state 與 delivery contract 仍由 `@line-work/notifications` 擁有。Inbox 不建立第二套 owner、schema 或 package。
